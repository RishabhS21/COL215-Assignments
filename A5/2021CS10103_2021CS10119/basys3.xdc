...
set_property PACKAGE_PIN W17 [get_ports {continue}]                                       
...
set_property PACKAGE_PIN U2 [get_ports {vec[0]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {vec[0]}]
set_property PACKAGE_PIN U4 [get_ports {vec[1]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {vec[1]}]
set_property PACKAGE_PIN V4 [get_ports {vec[2]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {vec[2]}]
set_property PACKAGE_PIN W4 [get_ports {vec[3]}]                                        
